...
function SidebarProvider({
  ...
  const isMobile = useSidebarBreakpoint();
...
function Sidebar({
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "text-sidebar-foreground dark:bgcolor-bgsecondary flex h-full w-(--sidebar-width) flex-col bg-[#FFFFFF]",
          className
        )}
        {...props}
      >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="dark:bgcolor-bgsecondary bg-[#FFFFFF] md:w-80 md:max-w-80 [&>button]:hidden"
          style={
            {
  ...
  return (
    <div
      className="peer text-sidebar-foreground hidden lg:block"
      data-state={state}
    ...
    >
      ...
      >
        <div
          ...
          className="dark:bgcolor-bgsecondary flex h-full w-full flex-col bg-[#FFFFFF] group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
