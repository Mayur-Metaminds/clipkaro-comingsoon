...
export const Footer = () => {
  return (
    <footer className="w-full py-8 px-4 z-20 relative ">
      <div className="max-w-4xl relative mx-auto flex flex-col items-center text-center space-y-1">
        <h3
          className=" relative text-center  font-dm-sans-600  text-[20px]  leading-[29px]  tracking-[-0.4px]  bg-[linear-gradient(128deg,#95A9CC_25.87%,#BBCFF0_74.13%)]  bg-clip-text
  text-transparent"
        >
          FOLLOW OUR JOURNEY
        </h3>
  ...
  text-[20px]  font-semibold  leading-[29px]  tracking-[-0.4px]  text-[rgba(149,169,204,0.70)]
"
        >
        ...
        <div className="flex items-center  mt-10 gap-24">
          <a
            href="#"
            className="flex items-center gap-2 text-white text-center font-dm-sans-600 text-[20px]  leading-[29px] tracking-[-0.4px] hover:text-white/80  transition-colors"
          >
            {/* <Instagram /> */}
        ...
        <p className="  text-center  font-dm-sans-600 text-[20px]    leading-[29px]  tracking-[-0.4px]  text-[#95A9CC]/70  mt-8">
